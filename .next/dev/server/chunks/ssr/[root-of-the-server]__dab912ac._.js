...
apiClient.interceptors.request.use((config)=>{
    ...
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])('accessToken');
    if (token) {
...
apiClient.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            const refreshToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])('refreshToken');
            if (refreshToken) {
                ...
                // Save new token (persist based on where refreshToken was found is tricky, 
                // but for simplicity we can just update localStorage if it was there, or assume session if not.
                // Given our setToken clears both first, we need to know where to put it.
                // Alternatively, we can let the authService handle saving if we redirect to login,
                // but here we just need to update the token in place.
                // For now, let's just update based on where the old access token MIGHT have been.
                // Actually, a simpler approach for refresh is to just update in place.
                // But since we don't know "remember me" state here easily without checking where refreshToken came from.
                // Let's assume session storage unless we can prove otherwise, OR just update both? No.
                // Best effort: if refreshToken is in localStorage, use localStorage.
                const isRemembered = ("TURBOPACK compile-time value", "undefined") !== 'undefined' && !!localStorage.getItem('refreshToken');
...
const login = async (credentials)=>{
    ...
    if (data.data && !data.data.isPreAccess) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])('accessToken', data.data.accessToken, remember);
        if (data.data.refreshToken) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])('refreshToken', data.data.refreshToken, remember);
        }
        ...
        // Pre-access token (always session or specific logic? default to session for safety or same as login)
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])('preAccessToken', data.data.accessToken, false); // Usually temporary
...
const verify2FA = async (otp)=>{
    ...
    if (data.data && !data.data.isPreAcesss) {
        // Default to session storage after 2FA unless we tracked "remember me" state through the flow
        // Ideally "remember me" should be part of the pre-access payload or stored temporarily
        // For now, let's default to false (session) or true (local) - maybe safe to default to false
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])('accessToken', data.data.accessToken, false);
        if (data.data.refreshToken) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])('refreshToken', data.data.refreshToken, false);
        }
        if (data.data.clientId) {
...
const getCurrentUser = async ()=>{
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/me');
    return data.data;
};
...
;
function Header() {
    const { isLoggedIn, user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                    className: "hidden gap-6 text-sm text-slate-600 md:flex",
                    children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "h-8 w-8 rounded-full bg-gradient-to-br from-dermcare to-blue-500 flex items-center justify-center text-white font-semibold text-sm",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dab912ac._.js.map